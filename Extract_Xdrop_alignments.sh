...
PCR_CLIP_READS="java -jar /home/simone/software/jvarkit/dist/pcrclipreads.jar"
SAM_EXTRACT_CLIP="java -jar /home/simone/software/jvarkit/dist/samextractclip.jar"
SEQTK=seqtk
MINIMAP2=minimap2
SAMTOOLS=samtools
BEDTOOLS=bedtools
...
mkdir $WORKING_DIR"/Xdrop_reads_extraction"
mv $BAM_target $FASTQ_forward $BAM_target_forward $SAM_target_clipped $BAM_target_clipped $FASTQ_target_clipped $FASTQ_target_clipped_ids $WORKING_DIR"/Xdrop_reads_extraction"
