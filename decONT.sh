...
$VSEARCH --cluster_smallmem $FASTA --usersort --id $THR --iddef 2 --clusterout_sort --fasta_width 0 --strand both --sizeout --consout $wdir"/consensus_"$sample_id".fasta" --clusters $prefix
